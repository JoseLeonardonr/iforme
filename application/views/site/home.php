            ...
            <div class="mdl-grid portfolio-max-width">
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work01.jpg" border="0" alt="">
                    </div>
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work07.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work02.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work03.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work04.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work08.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work05.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work06.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                    <div class="mdl-card__media">
                        <img class="article-image" src="assets/imagens/example-work09.jpg" border="0" alt="">
                    </div>
                    <div class="mdl-card__title">
